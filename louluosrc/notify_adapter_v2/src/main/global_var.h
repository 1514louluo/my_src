...
extern log4cplus::Logger g_activity_loger;
extern log4cplus::Logger g_platform_loger;
...
//#define  LOGINTRACK_LOG(logEvent)     LOG4CPLUS_ERROR(g_logintrack_logger, logEvent) 
#define  MONGODB_LOG(logEvent)     LOG4CPLUS_ERROR(g_mongodb_loger, logEvent) 
#define  ACTIVITY_LOG(logEvent)     LOG4CPLUS_ERROR(g_activity_loger, logEvent)   
#define  PLATFORM_LOG(logEvent)     LOG4CPLUS_ERROR(g_platform_loger, logEvent)  
