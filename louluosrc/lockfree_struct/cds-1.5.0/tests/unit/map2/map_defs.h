...
#   define CDSUNIT_DECLARE_MichaelMap_RCU_signal \
    TEST_MAP(MichaelMap_RCU_SHB_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_RCU_SHB_less_michaelAlloc) \
    TEST_MAP(MichaelMap_RCU_SHT_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_RCU_SHT_less_michaelAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_SHB_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_SHB_less_michaelAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_SHT_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_SHT_less_michaelAlloc)
...
#define CDSUNIT_DECLARE_MichaelMap  \
    ...
    TEST_MAP(MichaelMap_RCU_GPI_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_RCU_GPI_less_michaelAlloc) \
    TEST_MAP(MichaelMap_RCU_GPB_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_RCU_GPB_less_michaelAlloc) \
    TEST_MAP(MichaelMap_RCU_GPT_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_RCU_GPT_less_michaelAlloc) \
    ...
    TEST_MAP(MichaelMap_Lazy_RCU_GPI_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_GPI_less_michaelAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_GPB_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_GPB_less_michaelAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_GPT_cmp_stdAlloc) \
    TEST_MAP(MichaelMap_Lazy_RCU_GPT_less_michaelAlloc)\
...
#   define CDSUNIT_DECLARE_SplitList_RCU_signal  \
    TEST_MAP(SplitList_Michael_RCU_SHB_dyn_cmp)\
    TEST_MAP(SplitList_Michael_RCU_SHB_st_cmp)\
    TEST_MAP(SplitList_Michael_RCU_SHB_dyn_less)\
    TEST_MAP(SplitList_Michael_RCU_SHB_st_less)\
    TEST_MAP(SplitList_Michael_RCU_SHT_dyn_cmp)\
    TEST_MAP(SplitList_Michael_RCU_SHT_st_cmp)\
    TEST_MAP(SplitList_Michael_RCU_SHT_dyn_less)\
    TEST_MAP(SplitList_Michael_RCU_SHT_st_less)\
    TEST_MAP(SplitList_Lazy_RCU_SHB_dyn_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_SHB_st_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_SHB_dyn_less)\
    TEST_MAP(SplitList_Lazy_RCU_SHB_st_less)\
    TEST_MAP(SplitList_Lazy_RCU_SHT_dyn_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_SHT_st_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_SHT_dyn_less)\
    TEST_MAP(SplitList_Lazy_RCU_SHT_st_less)
...
#define CDSUNIT_DECLARE_SplitList  \
    ...
    TEST_MAP(SplitList_Michael_RCU_GPI_dyn_cmp)\
    TEST_MAP(SplitList_Michael_RCU_GPI_st_cmp)\
    TEST_MAP(SplitList_Michael_RCU_GPI_dyn_less)\
    TEST_MAP(SplitList_Michael_RCU_GPI_st_less)\
    TEST_MAP(SplitList_Michael_RCU_GPB_dyn_cmp)\
    TEST_MAP(SplitList_Michael_RCU_GPB_st_cmp)\
    TEST_MAP(SplitList_Michael_RCU_GPB_dyn_less)\
    TEST_MAP(SplitList_Michael_RCU_GPB_st_less)\
    TEST_MAP(SplitList_Michael_RCU_GPT_dyn_cmp)\
    TEST_MAP(SplitList_Michael_RCU_GPT_st_cmp)\
    TEST_MAP(SplitList_Michael_RCU_GPT_dyn_less)\
    TEST_MAP(SplitList_Michael_RCU_GPT_st_less)\
    ...
    TEST_MAP(SplitList_Lazy_RCU_GPI_dyn_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_GPI_st_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_GPI_dyn_less)\
    TEST_MAP(SplitList_Lazy_RCU_GPI_st_less)\
    TEST_MAP(SplitList_Lazy_RCU_GPB_dyn_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_GPB_st_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_GPB_dyn_less)\
    TEST_MAP(SplitList_Lazy_RCU_GPB_st_less)\
    TEST_MAP(SplitList_Lazy_RCU_GPT_dyn_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_GPT_st_cmp)\
    TEST_MAP(SplitList_Lazy_RCU_GPT_dyn_less)\
    TEST_MAP(SplitList_Lazy_RCU_GPT_st_less)\
...
#   define CDSUNIT_DECLARE_SkipListMap_RCU_signal \
    TEST_MAP_NOLF(SkipListMap_rcu_shb_less_pascal)\
    TEST_MAP_NOLF(SkipListMap_rcu_shb_cmp_pascal_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_shb_less_xorshift)\
    TEST_MAP_NOLF(SkipListMap_rcu_shb_cmp_xorshift_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_sht_less_pascal)\
    TEST_MAP_NOLF(SkipListMap_rcu_sht_cmp_pascal_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_sht_less_xorshift)\
    TEST_MAP_NOLF(SkipListMap_rcu_sht_cmp_xorshift_stat)
...
#define CDSUNIT_DECLARE_SkipListMap \
    TEST_MAP_NOLF(SkipListMap_hp_less_pascal)\
    TEST_MAP_NOLF(SkipListMap_hp_cmp_pascal_stat)\
    TEST_MAP_NOLF(SkipListMap_hp_less_xorshift)\
    TEST_MAP_NOLF(SkipListMap_hp_cmp_xorshift_stat)\
    TEST_MAP_NOLF(SkipListMap_hrc_less_pascal)\
    TEST_MAP_NOLF(SkipListMap_hrc_cmp_pascal_stat)\
    TEST_MAP_NOLF(SkipListMap_hrc_less_xorshift)\
    TEST_MAP_NOLF(SkipListMap_hrc_cmp_xorshift_stat)\
    TEST_MAP_NOLF(SkipListMap_ptb_less_pascal)\
    TEST_MAP_NOLF(SkipListMap_ptb_cmp_pascal_stat)\
    TEST_MAP_NOLF(SkipListMap_ptb_less_xorshift)\
    TEST_MAP_NOLF(SkipListMap_ptb_cmp_xorshift_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpi_less_pascal)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpi_cmp_pascal_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpi_less_xorshift)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpi_cmp_xorshift_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpb_less_pascal)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpb_cmp_pascal_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpb_less_xorshift)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpb_cmp_xorshift_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpt_less_pascal)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpt_cmp_pascal_stat)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpt_less_xorshift)\
    TEST_MAP_NOLF(SkipListMap_rcu_gpt_cmp_xorshift_stat)\
...
#   define CDSUNIT_DECLARE_EllenBinTreeMap_RCU_signal \
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_shb)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_shb_stat)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_sht)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_sht_stat)
...
#define CDSUNIT_DECLARE_EllenBinTreeMap \
    TEST_MAP_NOLF(EllenBinTreeMap_hp)\
    TEST_MAP_NOLF(EllenBinTreeMap_hp_stat)\
    TEST_MAP_NOLF(EllenBinTreeMap_ptb)\
    TEST_MAP_NOLF(EllenBinTreeMap_ptb_stat)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_gpi)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_gpi_stat)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_gpb)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_gpb_stat)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_gpt)\
    TEST_MAP_NOLF(EllenBinTreeMap_rcu_gpt_stat)\
