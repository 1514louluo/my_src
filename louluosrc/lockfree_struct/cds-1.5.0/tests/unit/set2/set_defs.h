...
#   define CDSUNIT_DECLARE_EllenBinTreeSet_RCU_signal \
        TEST_SET_NOLF(EllenBinTreeSet_rcu_shb)\
        TEST_SET_NOLF(EllenBinTreeSet_rcu_shb_stat)\
        TEST_SET_NOLF(EllenBinTreeSet_rcu_sht)\
        TEST_SET_NOLF(EllenBinTreeSet_rcu_sht_stat)
...
#define CDSUNIT_DECLARE_EllenBinTreeSet \
    TEST_SET_NOLF(EllenBinTreeSet_hp)\
    TEST_SET_NOLF(EllenBinTreeSet_hp_stat)\
    TEST_SET_NOLF(EllenBinTreeSet_ptb)\
    TEST_SET_NOLF(EllenBinTreeSet_ptb_stat)\
    TEST_SET_NOLF(EllenBinTreeSet_rcu_gpi)\
    TEST_SET_NOLF(EllenBinTreeSet_rcu_gpi_stat)\
    TEST_SET_NOLF(EllenBinTreeSet_rcu_gpb)\
    TEST_SET_NOLF(EllenBinTreeSet_rcu_gpb_stat)\
    TEST_SET_NOLF(EllenBinTreeSet_rcu_gpt)\
    TEST_SET_NOLF(EllenBinTreeSet_rcu_gpt_stat)\
