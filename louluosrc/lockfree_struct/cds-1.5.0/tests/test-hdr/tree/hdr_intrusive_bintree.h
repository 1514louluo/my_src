    ...
    protected:
        ...
        void test()
        {
            ...
            tree_type t ;
            {
                ...
                CPPUNIT_ASSERT( t.extract( v2.nKey ) == &v2 )   ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 4 )) ;
                CPPUNIT_ASSERT( t.extract( v2.nKey ) == NULL )   ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 4 )) ;

                CPPUNIT_ASSERT( t.extract_min() == &v5 ) ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 3 )) ;
                CPPUNIT_ASSERT( t.extract_min() == &v1 ) ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 2 )) ;
                CPPUNIT_ASSERT( t.extract_min() == &v4 ) ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 1 )) ;
                CPPUNIT_ASSERT( t.extract_min() == &v3 ) ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 0 )) ;
                ...
                CPPUNIT_ASSERT( t.extract_with( v4.nKey, less<value_type>() ) == &v4 )   ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 4 )) ;
                CPPUNIT_ASSERT( t.extract_with( v4.nKey, less<value_type>() ) == NULL )   ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;

                CPPUNIT_ASSERT( t.extract_max() == &v3 ) ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 3 )) ;
                CPPUNIT_ASSERT( t.extract_max() == &v2 ) ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 2 )) ;
                CPPUNIT_ASSERT( t.extract_max() == &v1) ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( !t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 1 )) ;
                CPPUNIT_ASSERT( t.extract_max() == &v5 ) ;
                CPPUNIT_ASSERT( t.check_consistency() ) ;
                CPPUNIT_ASSERT( t.empty() ) ;
                CPPUNIT_ASSERT( misc::check_size( t, 0 )) ;
...

            {
                ...
                for ( int n = 0; n < (int) c_nItemCount; ++n ) {
                    value_type * p = t.extract_min() ;
                    CPPUNIT_ASSERT_MSG( p != NULL, n )  ;
                    if ( p ) {
                        CPPUNIT_ASSERT_MSG( p->nKey ==n , "extract_min(" << n << ") == " << p->nKey )  ;
                    }
                }
                ...
                for ( int n = (int) c_nItemCount - 1; n >= 0; --n ) {
                    value_type * p = t.extract_max() ;
                    CPPUNIT_ASSERT_MSG( p != NULL, n )  ;
                    if ( p ) {
                        CPPUNIT_ASSERT_MSG( p->nKey ==n , "extract_max(" << n << ") == " << p->nKey )  ;
                    }
                }
