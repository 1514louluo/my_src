...
#       endif
        ...
        void test()
        {
            ...
            // extract min/max
            {
                ...
                value_type v ;
                while ( !s.empty() ) {
                    CPPUNIT_ASSERT( s.extract_min( v ) ) ;
                    CPPUNIT_ASSERT( v.nKey == i ) ;
                    ++i ;
                }
                CPPUNIT_ASSERT( s.empty() )     ;
                CPPUNIT_ASSERT( check_size( s, 0 )) ;
                ...
                extract_functor f ;
                while ( !s.empty() ) {
                    CPPUNIT_ASSERT( s.extract_min( v, cds::ref(f) ) ) ;
                ...
                while ( !s.empty() ) {
                    CPPUNIT_ASSERT( s.extract_max( v ) ) ;
                    CPPUNIT_ASSERT( v.nKey == i ) ;
                    --i ;
                }
                CPPUNIT_ASSERT( s.empty() )     ;
                ...
                i = (int) c_nItemCount - 1 ;
                while ( !s.empty() ) {
                    CPPUNIT_ASSERT( s.extract_max( v, cds::ref(f) ) ) ;
                    CPPUNIT_ASSERT( f.nKey == i ) ;
                    --i ;
                }
                CPPUNIT_ASSERT( s.empty() )     ;
