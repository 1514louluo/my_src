...
#   endif
    ...
    public:
        ...
        */
        ...
        @anchor cds_intrusive_MichaelList_rcu_extract
            ...
            if ( you_want_delete_item_extracted ) {
                ...
                // Now, it is safe to delete p1 and p2 after synchronization done
                if ( p1 ) delete p1;
                if ( p2 ) delete p2;

                // Way 2: using RCU retire_ptr
                // retire_ptr calls rcu::synchronize internally
        ...
        */
        ...
        {
            return extract_at( m_pHead, val, key_comparator() ) ;
        }

        /// Extracts an item from the list using \p pred predicate for searching
        /**
            This function is the analog for \ref cds_intrusive_MichaelList_rcu_extract "extract(Q const&)".
        ...
        */
        ...
        {
            return extract_at( m_pHead, val, cds::opt::details::make_comparator_from_less<Less>() );
        }
        ...
        try_again:
            ...
            while ( true ) {
                    ...
                    || pNext.bits() != 0 )  // pNext contains deletion mark for pCur
                {
                    ...
                    // that the RCU would be in unlocking state.
                    bkoff() ;
                    goto try_again    ;
                }
