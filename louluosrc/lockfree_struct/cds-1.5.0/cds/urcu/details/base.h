...
namespace cds {
    ...
    /** @ingroup cds_garbage_collector
        ...
        <b>Informally description of %RCU</b>
...
#       endif
        ...
        /**@anchor cds_urcu_rcu_deadlock
            This exception is raised when cds::opt::v::rcu_throw_deadlock deadlock checking policy
            is used, see cds::opt::rcu_check_deadlock option.
        */
