...
/** @ingroup cds_cxx11_stdlib_wrapper
    ...
    In case when an old compiler and corresponding std library has no required feature
    ...
    - if not the \p boost analog is used and it places into \p %cds_std namespace too
