...
#       endif
        ...
        /**
            If the set is not empty, the function returns \p true, \p dest contains the copy of minimum value
            (assignment operator is called for \p value_type).
            If the set is empty, the function returns \p false, \p dest is left unchanged.
        ...
        */
        bool extract_min( value_type& dest )
        {
            ...
            dest = pFound->m_Value  ;
            gc::retire( pFound, base_class::free_leaf_node ) ;
        ...
        /// Extracts an item with minimal key from the set
        /**
            If the set is not empty, the function returns \p true, \p f functor is called with value found.
            If the set is empty, the function returns \p false, \p f functor is not called, \p dest is left unchanged.
        ...
        */
        ...
        /**
            If the set is not empty, the function returns \p true, \p dest contains the copy of maximum value
            (assignment operator is called for \p value_type).
            If the set is empty, the function returns \p false, \p dest is left unchanged.
        ...
        */
        bool extract_max( value_type& dest)
        {
