...
struct kfifo
{
//	 struct slist node;              /*this is slist node*/
...
struct kfifo_head
{
	struct slist head[2];    //busy and free
	struct slist *busy_in;
	struct slist *busy_out;
	int       busy_count;
	int       free_count;
...
extern kfifo_group_put(struct kfifo_head *head, 
					const unsigned char *buffer, unsigned int len);
extern kfifo_group_get(struct kfifo_head *head, 
					const unsigned char *buffer, unsigned int len);
*/
